...
function PreProcessing(props) {
    ...
    return (
        <Container sx={{display: 'flex',justifyContent: 'center',
            ...
            <Form logged={props.logged} setPreviousStep={props.setPreviousStep} setStep={props.setStep} setSubmitButton={props.setSubmitButton} previousStep={props.previousStep} step={props.step} submitButton={props.submitButton} preStep={props.preStep} setPreStep={props.setPreStep}/>
        </Container>
    );
}
